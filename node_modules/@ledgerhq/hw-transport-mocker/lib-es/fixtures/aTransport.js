...
export const aTransportBuilder = (props) => {
    return Object.assign({ exchangeTimeout: 30000, unresponsiveTimeout: 15000, deviceModel: null, tracer: new LocalTracer("mockedTransport", {}), _events: new EventEmitter(), exchangeBusyPromise: null, _appAPIlock: null, exchange: jest.fn(), exchangeBulk: jest.fn(), setScrambleKey: jest.fn(), close: jest.fn(), on: jest.fn(), off: jest.fn(), emit: jest.fn(), setDebugMode: jest.fn(), setExchangeTimeout: jest.fn(), setExchangeUnresponsiveTimeout: jest.fn(), send: jest.fn(), exchangeAtomicImpl: jest.fn(), decorateAppAPIMethods: jest.fn(), decorateAppAPIMethod: jest.fn(), setTraceContext: jest.fn(), getTraceContext: jest.fn() }, props);
};
