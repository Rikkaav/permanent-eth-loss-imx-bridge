...
const importEVMTokens = (outputDir) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const supportedChainIds = Object.values(currencies_1.cryptocurrenciesById)
        ...
        .sort((a, b) => a - b);
    yield Promise.allSettled(supportedChainIds.map((chainId) => __awaiter(void 0, void 0, void 0, function* () { return yield (0, exports.importTokenByChainId)(outputDir, chainId); })));
