...
`;
        ...
        yield (0, _1.importCardanoNativeTokens)(".");
        expect(mockedFs).toHaveBeenNthCalledWith(1, "cardanoNative.json", JSON.stringify(cardanoNativeTokens));
        expect(mockedFs).toHaveBeenNthCalledWith(2, "cardanoNative.ts", expectedFile);
    }));
});
//# sourceMappingURL=cardanoNative.test.js.map