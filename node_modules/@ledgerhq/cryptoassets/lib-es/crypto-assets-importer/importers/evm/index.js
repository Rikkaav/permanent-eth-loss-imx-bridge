...
export const importTokenByChainId = (outputDir, chainId) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        console.log(`importing chain with chainId: ${chainId}...`);
        const erc20 = yield fetchTokens(`evm/${chainId}/erc20.json`);
        const erc20Signatures = yield fetchTokens(`evm/${chainId}/erc20-signatures.json`);
...
`;
        if (erc20 && erc20Signatures) {
            ...
            yield fs.writeFile(path.join(dirPath, "erc20.json"), JSON.stringify(erc20));
            yield fs.writeFile(path.join(dirPath, "erc20-signatures.json"), JSON.stringify(erc20Signatures));
            yield fs.writeFile(path.join(dirPath, "index.ts"), indexTsStringified);
...
export const importEVMTokens = (outputDir) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const supportedChainIds = Object.values(cryptocurrenciesById)
        ...
        .sort((a, b) => a - b);
    yield Promise.allSettled(supportedChainIds.map((chainId) => __awaiter(void 0, void 0, void 0, function* () { return yield importTokenByChainId(outputDir, chainId); })));
...
`;
    yield fs.writeFile(`${outputDir}/evm/index.ts`, rootIndexStringified);
